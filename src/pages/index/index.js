...
Page({
    data: {
        ...
        quickList:[
          {name:'发布信息',icon:'../../images/index/quick1.png',path:'/pages/index/index'},
          {name:'寻物启示',icon:'../../images/index/quick2.png',path:'/pages/index/index'},
          {name:'寻主启示',icon:'../../images/index/quick3.png',path:'/pages/index/index'},
          {name:'领养活动',icon:'../../images/index/quick4.png',path:'/pages/index/index'},
        ],
        bannerIndex: 0,
        cityName: "",
        cc_noAuth: true,
